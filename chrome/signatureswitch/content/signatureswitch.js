...
var ss_main = {
    ...
    {
        var preLoadExecutable = Components.classes["@mozilla.org/file/local;1"].createInstance(Components.interfaces.nsILocalFile);
        var preLoadExecutablePath = ss_prefs.getComplexValue("preloadexecutablepath", Components.interfaces.nsISupportsString).data;
    ...
    loadSignatureProperty : function(idx)
    {
        ...
        try
        {
            dataString = ss_prefs.getComplexValue("signatures", Components.interfaces.nsISupportsString).data;
